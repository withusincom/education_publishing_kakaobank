  ...
  return (
    <>
      ...
      <StyledFlexCenter center>
        <Flex>
          <Image src="../../assets/images/main-withdrawal.png" width={473} />
        </Flex>
        <StyledFlex vertical>
      ...
      <StyledFlexCenter center>
        ...
        <Flex>
          <Image src="../../assets/images/main-savings.png" width={409} />
        </Flex>
      </StyledFlexCenter>
      <div className="section-divider" />
      <StyledFlexCenter center>
        <Flex>
          <Image src="../../assets/images/main-moim.png" width={460} />
        </Flex>
        <StyledFlex vertical>
          <Text bold={700} size={40} height={1.35}>
            함께 쓰고 같이 보는
      ...
      <StyledFlexCenter center>
        <StyledFlex vertical>
          ...
          <Button width={255} height={55}>
            ...
            <Image width={6} src="../../assets/images/home_arr.png" />
          </Button>
        </StyledFlex>
        <Flex>
